...
# Bot Information Configuration
# ============================
SESSION = environ.get('SESSION', 'Hell_King')   # Session name for the bot
...
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://telegra.ph/file/0ad1e20c4d0179d2cb06c.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/KVT.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/KVA.jpg'))
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-000').split()] #(make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002579079180")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002579079180")# Channels for force sub (make sure bot is admin)
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Hell_king_files') # Collection name (default: dreamcinezone_files)
...
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002579079180'))  # Notification of sent to your channel
DREAMXBOTZ_IMAGE_FETCH = bool(environ.get('DREAMXBOTZ_IMAGE_FETCH', True))  # On (True) / Off (False)
LINK_PREVIEW = bool(environ.get('LINK_PREVIEW', False)) # Shows link preview in notification msg instead of image
ABOVE_PREVIEW = bool(environ.get('ABOVE_PREVIEW', True)) # Shows link preview above the text in notification msg if True else below the msg
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://envs.sh/KVc.jpg")

TUTORIAL = environ.get("TUTORIAL", "ttps://t.me/The_hell_king_movie_group")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "ttps://t.me/The_hell_king_movie_group")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "ttps://t.me/The_hell_king_movie_group")   # Third tutorial link for verification
...
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'ttps://t.me/The_hell_king_movie_group') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'ttps://t.me/The_hell_king_movie_group') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'ttps://t.me/The_hell_king_movie_group') # Update channel link for the bot
